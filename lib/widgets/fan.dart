...
class MyFan extends StatefulWidget {
  const MyFan({super.key});

  @override
  State<MyFan> createState() => _MyFanState();
}

class _MyFanState extends State<MyFan> {
              ...
              Flexible(
                child: Center(
                  child: Container(
                    ...
                    child: Stack(
                      children: [
                        if (toggleSwitch[1] && isToggle == 1)
                          Image.asset("images/FAN/fan-body-red.png")
                        else if (toggleSwitch[1] && isToggle == 2)
                          Image.asset("images/FAN/fan-body-blue.png")
                        else if (toggleSwitch[1])
                          Image.asset("images/FAN/fan-body-amber.png")
                        else
                          Image.asset("images/FAN/fan-body.png"),
                        Positioned(
                          top: -55,
                          left: 4,
                          right: 0,
                          ...
                          child: Transform.rotate(
                            angle: angle,
                            child: Image.asset("images/FAN/fan-swing.png"),
                          ),
                        ),
                        Image.asset(
                          "images/FAN/fan-wrap-swing.png",
                        ),
                      ],
                    ),
                  ),
